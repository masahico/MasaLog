...
<?php endif; ?>
<ul class="snsp">
<?php if ( get_twitter_follow_id() )://Twitterフォローボタンを表示するか ?><li class="twitter-page"><a href="//twitter.com/masalog_net" target="_blank" title="<?php _e( 'Twitterをフォロー', 'simplicity2' ) ?>" rel="nofollow"><span class="icon-twitter-logo"></span></a></li><?php endif; ?>
